...
const KNOWN_KEYS = ['students', 'teachingUnits', 'classes', 'timetable', 'ideas', 'sops', 'goals', 'schoolEvents', 'workLogs', 'meetings', 'lessonRecords', 'tasks', 'hpAwardLogs', 'emailDigests'];
