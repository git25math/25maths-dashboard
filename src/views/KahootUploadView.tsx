    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-2xl font-bold text-slate-900">Kahoot Upload</h2>
          <p className="mt-1 max-w-3xl text-sm text-slate-500">
            Manage Kahoot titles, cover assets, question sets, tags, links, and upload stages in one workspace.
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
        {[
          ...
          { label: 'AI Generated', value: stats.ai_generated, tone: 'text-sky-700' },
          { label: 'Human Review', value: stats.human_review, tone: 'text-amber-700' },
          { label: 'Uploaded', value: stats.uploaded, tone: 'text-emerald-700' },
          { label: 'Missing Cover', value: stats.missing_cover, tone: 'text-rose-700' },
              ...
              <div className="glass-card p-5">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-3 text-2xl font-bold text-slate-900">{draft.title || 'Untitled Kahoot'}</h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="rounded-xl border border-slate-200 px-3 py-2 text-sm font-bold text-slate-600 transition hover:border-slate-300 hover:text-slate-900"
                    >
                      <span className="inline-flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-rose-200 px-3 py-2 text-sm font-bold text-rose-700 transition hover:bg-rose-50"
                    >
                      <span className="inline-flex items-center gap-2">
                ...
                <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
                  <div className="glass-card space-y-5 p-5">
                    ...
                    <div className="rounded-[28px] border border-slate-200 bg-slate-50 p-4">
                      ...
                      <div className="mt-3 space-y-2">
                        {[
                          { label: 'Title and description are filled', done: Boolean(draft.title.trim() && draft.description.trim()) },
                          { label: 'Cover asset is attached', done: Boolean(draft.cover_url) },
                          { label: 'Question set has at least one valid question', done: draft.questions.length > 0 && draft.questions.every(question => getQuestionIssueCount(question) === 0) },
                          { label: 'Page link is filled', done: Boolean(draft.page_url) },
                          { label: 'Play link is filled', done: Boolean(draft.challenge_url) },
                        ].map(item => (
