...
import { Check, Circle, Copy, ExternalLink, Save, X } from 'lucide-react';
...
export function PayhipDetailSheet({ item, onClose, onCopy, onSave, onTogglePipeline, onBulkPipeline, onNavigate }: PayhipDetailSheetProps) {
  ...
  useEffect(() => {
    const handler = (event: KeyboardEvent) => {
      // Skip navigation if user is typing in an input/textarea
        ...
        <div className="space-y-6 p-6">
          ...
          <section>
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-slate-400">{doneCount}/{PAYHIP_PIPELINE_STAGES.length} pipeline steps</span>
            </div>
