...
export const MOCK_KAHOOT_ITEMS: KahootItem[] = [
  {
    ...
    description: 'Introduce set notation, Venn diagrams, intersections, unions, and complements with short retrieval questions.',
    cover_url: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=1200&q=80',
    page_url: 'https://www.25maths.com/igcse-maths/cie-0580/number/c1-02-sets',
    challenge_url: 'https://kahoot.it/challenge/001645722',
    creator_url: 'https://create.kahoot.it/details/c1-02-sets',
    ...
    tags: ['cie0580', 'number', 'sets', 'core'],
    upload_status: 'uploaded',
    questions: [
      {
        id: 'kahoot-cie0580-c1-02-q1',
        prompt: 'Which symbol represents the intersection of two sets?',
        option_a: 'U',
        option_b: '∩',
        option_c: '⊂',
        option_d: '∈',
    ...
    review_notes: 'Uploaded and linked to production site.',
    created_at: '2026-03-01T09:00:00.000Z',
    updated_at: '2026-03-04T12:00:00.000Z',
    ai_generated_at: '2026-03-01T09:00:00.000Z',
    human_reviewed_at: '2026-03-02T11:30:00.000Z',
    uploaded_at: '2026-03-04T12:00:00.000Z',
  },
  {
    ...
    description: 'Extended-track number classification practice with primes, rationals, irrationals, and indices warm-up questions.',
    page_url: 'https://www.25maths.com/igcse-maths/cie-0580/number/e1-01-types-of-number',
    creator_url: 'https://create.kahoot.it/details/e1-01-types-of-number',
    ...
    tags: ['cie0580', 'number', 'extended', 'types-of-number'],
    upload_status: 'human_review',
    questions: [
      {
        id: 'kahoot-cie0580-e1-01-q1',
      ...
      {
        id: 'kahoot-cie0580-e1-01-q2',
        prompt: 'Which number is both prime and odd?',
        option_a: '2',
        option_b: '9',
        option_c: '15',
        option_d: '11',
    ...
    review_notes: 'Needs final wording pass before upload.',
    created_at: '2026-03-03T03:00:00.000Z',
    updated_at: '2026-03-06T06:15:00.000Z',
    ai_generated_at: '2026-03-03T03:00:00.000Z',
    human_reviewed_at: '2026-03-06T06:15:00.000Z',
  },
  {
    id: 'kahoot-edexcel-foundation-f1-03',
    board: 'edexcel-4ma1',
    track: 'foundation',
    topic_code: 'F1.3',
    title: 'Edexcel 4MA1 | F1.3 | Order of operations | FOUNDATION TRACK',
    description: 'First-pass AI draft for BIDMAS fluency and common calculator-free misconceptions.',
    tags: ['edexcel-4ma1', 'foundation', 'number', 'bidmas'],
    upload_status: 'ai_generated',
    questions: [
      {
        id: 'kahoot-edexcel-foundation-f1-03-q1',
        prompt: 'Evaluate 7 + 3 × 2.',
        option_a: '20',
        option_b: '13',
        option_c: '17',
        option_d: '10',
    ...
    review_notes: 'Missing cover, links, and manual quality check.',
    created_at: '2026-03-06T08:45:00.000Z',
    updated_at: '2026-03-06T08:45:00.000Z',
    ai_generated_at: '2026-03-06T08:45:00.000Z',
  },
];
