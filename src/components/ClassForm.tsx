      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Class Name</label>
            <input 
              required
              type="text" 
              value={formData.name}
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider">Current Unit</label>
            <select 
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all dark:bg-slate-700 dark:text-slate-100 h-24 resize-none"
